...
public interface RetrofitRequestInterface {
    ...
    @Multipart
    @POST
    Call<ResponseBody> uploadFileWithRequestBody(@Header("token") String token, @Url String url, @PartMap Map<String, RequestBody> params, @Part MultipartBody.Part file);

    @POST
    @Multipart
    Call<ResponseBody> uploadFile(@Header("token") String token, @Url String url, @Part MultipartBody.Part file);
